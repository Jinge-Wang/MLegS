...
!    do iii = 1,size(monitor_mk,1)
!       write(*,92) m(monitor_mk(iii,1)+1),ak(monitor_mk(iii,1)+1,monitor_mk(iii,2)+1),monitor_mk(iii,1)+1,monitor_mk(iii,2)+1
!    enddo
