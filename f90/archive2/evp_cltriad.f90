...
M_0 = 1; K_0 = 1.00; EIG_0 = -0.3*IU
M_1 = 1; K_1 = 2.00; EIG_1 = -0.3*IU
M_2 = 2; K_2 = 3.00; EIG_2 = -0.6*IU
...
IF (MPI_GLB_RANK .EQ. 0) THEN
    ...
    WRITE(K_VAL,'(F05.2)') K_0; CALL SAVE_VEL(RUR_0, RUP_0, UZ_0, './240612/vel_MK_'//ITOA3(M_0)//'_'//K_VAL//'_IND_'//ITOA3(II)//'_NRCHOP_'//ITOA3(NRCHOP)//'.output')
    ...
    WRITE(K_VAL,'(F05.2)') K_1; CALL SAVE_VEL(RUR_1, RUP_1, UZ_1, './240612/vel_MK_'//ITOA3(M_1)//'_'//K_VAL//'_IND_'//ITOA3(JJ)//'_NRCHOP_'//ITOA3(NRCHOP)//'.output')
    ...
    WRITE(K_VAL,'(F05.2)') K_2; CALL SAVE_VEL(RUR_2, RUP_2, UZ_2, './240612/vel_MK_'//ITOA3(M_2)//'_'//K_VAL//'_IND_'//ITOA3(KK)//'_NRCHOP_'//ITOA3(NRCHOP)//'.output')
    ...
    ! ======================================================================
    CALL COLLOC_INFO()
    CALL SAVE_VEL(CMPLX(RUR0), CMPLX(RUP0), CMPLX(UZ0), './240612/vel_MK_'//ITOA3(0)//'_'//ITOA4(0) &
    ...
    ! PERTURBATION FILES
    CALL SAVE_PERTURB('./240612/new_perturb.input', &
