...
PROGRAM create_perturb_wing
    ...
    !=======================================================================
          ...
          INTEGER     :: MIND,AKIND,MREAD,IS,NDIM,EIG_NUM
          REAL(P8)    :: AKREAD,rp1,ip1
          INTEGER,DIMENSION(:),ALLOCATABLE::EIG_INDEX
...
!     107  FORMAT('PROGRESS: ',I3.3,'/',I3.3)
          ...
          WRITE(*,*) 'NUMBER OF EIGVEN_VEC:'
          READ(5,'(I72)') EIG_NUM
          ! Number of perturbation (currently: 1 at a time)
          WRITE(10,'(I2)') EIG_NUM
          ALLOCATE(EIG_INDEX(EIG_NUM))
          ...
          READ(5,'(I72)') EIG_INDEX(J) ! EIG_INDEX now becomes the index of the desired eigenvalue
          ! Scale
          WRITE(6,*) ''
          WRITE(6,*) 'SELECT SCALE'
          WRITE(6,*) 'REAL(SCALE) ='
          READ(5,*) rp1
          WRITE(6,*) 'IMAG(SCALE) ='
          READ(5,*) ip1
          ...
          DO J = 1,EIG_NUM
          EIG_VAL_DESIRED = EIG_VAL(EIG_INDEX(J))
          EIG_VEC_DESIRED = EIG_VEC(:,EIG_INDEX(J))
          !PSIU%LN = 0.D0
          CHIU%LN = 0.D0
          !PSIU%E = 0.D0
          CHIU%E = 0.D0
          ...
          CALL IDEL2(CHIU,CHIU) ! Original Eigenvec are in terms of [Psi,DEL2(Chi)]
 ...
 1        DEALLOCATE( H )
    ...
    ! N/A
    !=======================================================================
    END PROGRAM create_perturb_wing
    !=======================================================================