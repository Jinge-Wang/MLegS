...
!=======================================================================
  ...
  106  FORMAT('M = ',I8,' & K = ',F8.3)
      ...
      NN = NRCHOPS(MIND)
      CHOP_N = 6
      ALLOCATE(H(2*NN,2*NN))
      ALLOCATE(EIG_VEC_3D(NR,2*NN,3))
      ...
      DO I = 1,NN
        ...
        H(:NN,  I) = PSI1%E(:NN,MIND,AKIND)
        H(NN+1:,I) = CHI1%E(:NN,MIND,AKIND) ! DEL2CHI
        ...
        H(:NN,  I+NN) &
                            = PSI1%E(:NN,MIND,AKIND)
        H(NN+1:,I+NN) &
                            = CHI1%E(:NN,MIND,AKIND) ! DEL2CHI
