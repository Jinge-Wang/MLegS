PROGRAM EVP_ALMOST_DISCRETE_SCAN
!=======================================================================
! [USAGE]: 
! Oldest version. Calculate bar term every single time.
! 
...
! ======================================================================
    ...
    ! ANALYSIS
    ! 1. SAVE UR, UP, UZ
    ! call SAVE_VEL(RUR_BAR,RUP_BAR,UZ_BAR,'vel_0.output')
    ! call SAVE_VEL(RUR_1,RUP_1,UZ_1,'vel_1.output')
    ! call SAVE_VEL(RUR_2,RUP_2,UZ_2,'vel_2.output')
    ENDIF

! DEALLOCATE 
!=======================================================================     
10  IF(ALLOCATED(M_mat)) DEALLOCATE(M_mat)
...
END PROGRAM EVP_ALMOST_DISCRETE_SCAN
!=======================================================================
