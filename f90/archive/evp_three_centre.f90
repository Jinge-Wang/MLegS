...
! SPATIAL SYMMETRY
QPAIR%H(1) = 0.40
M_0 = 2; M_1 = 3; M_2 = M_0 + M_1
K_0 = -0.40; K_1 = -0.70; K_2 = K_0 + K_1 ! ALL K = 0
...
IF (MPI_GLB_RANK.EQ.0) THEN
    ...
    KK = MAXLOC(REAL(M_eig_2),DIM=1,MASK=(AIMAG(M_eig_2).LT.-4))
