...
! CALL CALC_BOUSSI_VISC_BE(PSIO,CHIO,0.5D0*TIM%DT)
! CALL CALC_INCOMP_HYPERV(PSIO,CHIO,0.5D0*TIM%DT)
...
! CALL CALC_BOUSSI_VISC_BE(PSI,CHI,TIM%DT)
! CALL CALC_INCOMP_HYPERV(PSI,CHI,TIM%DT)
