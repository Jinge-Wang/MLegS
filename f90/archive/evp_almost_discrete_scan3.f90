PROGRAM EVP_ALMOST_DISCRETE_SCAN3
!=======================================================================
! [USAGE]: 
...
!=======================================================================
    ...
    REAL(P8):: rp1,ip1
    ! ZERO-CROSSING LIMIT:
    INTEGER,PARAMETER:: CROSS_LIMIT = 14
    ! SCANNING:
...
! ======================================================================
loop_ind: DO EIG_BAR_IND = 1,14
CALL MPI_BARRIER(MPI_COMM_WORLD,IERR)
IF ((M_BAR.EQ.0).AND.(EIG_BAR_IND.GT.4)) CYCLE
JUMP_FLAG = 0   
    ...
    ! =================== CHECK IF CRITICAL LAYER MODE =====================
        IF (M_BAR.EQ.0) THEN
            IF (ABS(IMAG(EIG_BAR))/QPAIR%Q(1).LT.0.01) JUMP_FLAG = 39
        ELSEIF (M_BAR.LE.3) THEN
...
! !=======================================================================
DO M_1 = 0,(10-M_BAR)
IF ((M_BAR.EQ.0).AND.(M_1.EQ.0)) CYCLE ! ONLY SCAN M_BAR = 0 & M_1 != 0
IF ((M_BAR.NE.0).AND.(M_1.NE.0)) CYCLE !        OR M_BAR != 0 & M_1 = 0
...
!     ENDIF
    ...
    IF (MPI_GLB_RANK.EQ.0) THEN
        ...
        ! WRITE(*,*) M_BAR, K_BAR, EIG_BAR_IND, M_1, K_VAL_1_0
    ...
    ! Find possible K_shift
        ...
        DO JJ = 1,CROSS_LIMIT !N_mat1!2*N_mat1
            ...
            IF ((M_1.NE.0).AND.(JJ.GT.4)) THEN
                K_tune(JJ) = 100.D0
            ELSEIF ((M_1.EQ.0).AND.(ABS(IMAG(M_eig_1_0(JJ)))/QPAIR%Q(1).LT.0.01)) THEN
                K_tune(JJ) = 100.D0
            ELSEIF ((M_1.LE.3).AND.(IMAG(M_eig_1_0(JJ)).GT.-(M_1*QPAIR%Q(1) + K_VAL_1_0*QPAIR%H(1)))) THEN
                K_tune(JJ) = 100.D0
            ...
            ELSE
                ...
                DO KK = 1,CROSS_LIMIT !N_mat2!2*N_mat2
                    IF ((M_2.NE.0).AND.(KK.GT.4)) THEN
                        K_tune_JJ(KK) = 100.D0
                    ELSEIF ((M_2.EQ.0).AND.(ABS(IMAG(M_eig_2_0(KK)))/QPAIR%Q(1).LT.0.01)) THEN
                        K_tune_JJ(KK) = 100.D0
                    ELSEIF (ABS(REAL(M_eig_2_0(KK) - M_eig_1_0(JJ) - EIG_BAR)) .GT. 1.0E-8) THEN ! Arbitrary threshold
                        K_tune_JJ(KK) = 100.D0
...
END PROGRAM EVP_ALMOST_DISCRETE_SCAN3
!=======================================================================
