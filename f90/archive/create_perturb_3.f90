...
PROGRAM create_perturb_3
    ...
    !=======================================================================
          ...
          REAL(P8)    :: AKREAD,rp1,ip1,EIG_ENE,norm_fact
    ...
    !     107  FORMAT('PROGRESS: ',I3.3,'/',I3.3)
          ...
          ! Normalization 0.63817*q
          CALL PC2VEL(PSIU,CHIU,RURU,RUPU,UZU)
          CALL TOFP(RURU)
          CALL TOFP(RUPU)
          CALL TOFP( UZU)
          norm_fact = MAXVAL(ABS(RUPU%E))/ MAXVAL(ABS(0.63817*QPAIR%Q))
          RURU%E = RURU%E/norm_fact
          RUPU%E = RUPU%E/norm_fact
           UZU%E =  UZU%E/norm_fact
          CALL PROJECT(RURU,RUPU,UZU,PSIU,CHIU)
