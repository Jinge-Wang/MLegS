...
! ======================================================================
   ...
   DO I1 = 1,SIZE(PSI1%E,2); DO J1 = 1,SIZE(PSI1%E,3)
      IF ((I1+PSI1%INTH .EQ. MONITORDATA%MK(4,1)+1).AND.(J1+PSI1%INX .EQ. MONITORDATA%MK(4,2)+1) &
         .OR. ((I1+PSI1%INTH .EQ. MONITORDATA%MK(1,1)+1).AND.(J1+PSI1%INX .EQ. MONITORDATA%MK(1,2)+1))) THEN
         PSI1%e(:,I1,J1) = PSI0%e(:,I1,J1)
         CHI1%e(:,I1,J1) = CHI0%e(:,I1,J1)
      ENDIF
      ! M = 0, K != 0
      IF ((MONITORDATA%MK(1,1).EQ.0).AND.(I1+PSI1%INTH .EQ. MONITORDATA%MK(1,1)+1).AND.(J1+PSI1%INX .EQ. 2*NXCHOP-MONITORDATA%MK(1,2))) THEN
         PSI1%e(:,I1,J1) = PSI0%e(:,I1,J1)
         CHI1%e(:,I1,J1) = CHI0%e(:,I1,J1)
      ENDIF
   ENDDO; ENDDO
