...
! [NOTES]:
! ORIGINAL PRODUCT_MK FUNCTION:
! THIS FUNCTION COMPUTES THE DOT PRODUCT OVER NON-NEGATIVE M AND K MODES,
! REQUIRING DIVISION BY 2 FOR M=0 AND K=0 MODES TO ACCOUNT FOR SYMMETRY.
! 
! NOTE ON PARALLELIZATION:
! IN MPI PARALLEL EXECUTION, SCALARS IN PFF_SPACE ARE DISTRIBUTED OVER
! BOTH M AND K. SINCE THE PHYSICAL SPACE IS ASSUMED REAL, ONLY NON-NEGATIVE
! M MODES ARE STORED. HOWEVER, FOR K, BOTH POSITIVE AND NEGATIVE MODES ARE
! STORED AND DISTRIBUTED. THEREFORE, IT IS NO LONGER IDEAL TO COMPUTE DOT
! PRODUCT OVER NON-NEGATIVE K MODES. THE CURRENT CODE IS PROBLEMATIC FOR
! PARALLEL EXECUTION.
!
! REPLACEMENT:
! THIS FUNCTION IS DEPRECATED AND SHOULD NOT BE USED IN NEW CODE.
! USE PRODUCT_MK_MODIFIED FUNCTION FOR CORRECT PARALLEL BEHAVIOR.
! ======================================================================
   ...
   CALL MPRINT('PRODUCT_MK IS DEPRECATED. USE PRODUCT_MK_MODIFIED INSTEAD.')
   CALL MPI_ABORT(MPI_COMM_IVP, IERR)
...
! [NOTES]:
! THIS FUNCTION IS DEPRECATED. SEE THE DOCUMENTATION FOR 
! PRODUCT_MK FUNCTION FOR DETAILS.
!  ------------------------------------------------------    
   IMPLICIT NONE 
   TYPE(SCALAR):: PSI,CHI,W1,W2
   REAL(P8):: ENERGY_SPEC(NTCHOP,NXCHOP)

   CALL MPRINT('ENERGY_SPEC IS DEPRECATED. USE ENERGY_SPEC_MODIFIED INSTEAD.')
   CALL MPI_ABORT(MPI_COMM_IVP, IERR)
