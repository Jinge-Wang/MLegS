...
IF(RUR%SPACE.EQ.PPP_SPACE .OR. RUP%SPACE.EQ.PPP_SPACE .OR. UZ%SPACE.EQ.PPP_SPACE) THEN
...
ELSEIF (RUR%SPACE.NE.PFF_SPACE .OR. RUP%SPACE.NE.PFF_SPACE .OR. UZ%SPACE.NE.PFF_SPACE) THEN
