...
!=======================================================================
  ...
  IF(MOD(TIM%N,DIAGV%IT1).EQ.0) THEN
    ...
    ! 
    ! INT[PSI%LN*DELSQH(PSI%LN)]
    ! = (PSI%LN)^2 * 2PI*ZLEN * 2(1-LN(2))
    ! HOWEVER, THIS IS NOT CONTAINED IN THE CURRENT DIAGNOSTICS.
    ! ACCORDING TO MATSUSHIMA & MARCUS, PSI%LN IN MANY CASES IS ZERO, E.G. IF THE VECTOR FIELD IS THE 
    ! NONLINEAR ADVECTION TERM (W X U). BUT I'M NOT SURE IF THIS IS STILL TRUE FOR THE BOUSSINESQ.
    RUP=PSI
