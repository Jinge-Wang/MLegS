...
IF (ALLOCATED(MONITOR_MK)) THEN
  WRITE(FUNIT,'(A)') 'MONITOR_MK'
  WRITE(FUNIT,'(A)') '#    NUM --------------------------------- (NUMBER OF MONITORING MODES)'
  WRITE(FUNIT,'(I8)') SIZE(MONITOR_MK,1)
  WRITE(FUNIT,'(A)') '# ---------------------------------------------------------------------'
  WRITE(FUNIT,'(A)') '#     MM      KK --------(AZIMUTHAL & AXIAL WAVENUMBER TO BE MONITORED)'
  WRITE(FUNIT,'(A)') '#     MM = 0,1,2,...; KK = 0,1,2,...;'
  
  DO I=1,SIZE(MONITOR_MK,1)
    WRITE(FUNIT,'(2I8)') INT(MONITOR_MK(I,1)), INT(MONITOR_MK(I,2))
  ENDDO
  WRITE(FUNIT,'(A)') '# ---------------------------------------------------------------------'
