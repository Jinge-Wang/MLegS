...
#SBATCH -J vort-221020        # Job name
#SBATCH -o vort8.o%j          # Name of stdout output file
#SBATCH -e vort8.e%j          # Name of stderr error file
...
printf '%s\n' "per_perturb" "T" | srun --mpi=pmi2 -n $SLURM_NTASKS ./bin/addperturb_non_exec
#echo "new_perturb" | srun --mpi=pmi2 -n $SLURM_NTASKS ./bin/addperturb_non_exec
echo "per_perturb" | srun --mpi=pmi2 -n $SLURM_NTASKS ./bin/vort8_exec
end_time="$(date -u +%s.%N)"
