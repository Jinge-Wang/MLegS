...
#SBATCH -o vort10.o%j         # Name of stdout output file
#SBATCH -e vort10.e%j         # Name of stderr error file
...
echo "per_perturb" | srun --mpi=pmi2 -n $SLURM_NTASKS ./bin/vort10_exec
end_time="$(date -u +%s.%N)"
